...
\vspace{0.1cm}
joint distribution on $\mathcal{S} \times \mathcal{O}$ from $\beta_t$: $\pi \paren{ o', s' \sachant \beta_t, a}$ \\
\vspace{0.3cm}
\visible<4->{
$\rightarrow$ \textbf{next belief state:} $\beta_{t+1}(s') = \pi \paren{ o', s' \sachant \beta_t, a}$ \\
unless $s'$ maximizes $\pi \paren{ o', s' \sachant \beta_t, a}$, then $\beta_{t+1}(s') = 1$
\vspace{0.3cm}
...
% questions
\frame{
\frametitle{\hspace{0.5cm}  \includegraphics[scale=0.35]{logo2015} \hspace{0.7cm}  
\begin{tikzpicture}
\node[opacity=0.2] at (0,0) { \includegraphics[scale=0.32]{Logo_EDSYS2}};
\end{tikzpicture}
\hspace{0.6cm} \includegraphics[scale=0.5]{onera}  }
\vspace{-0.1cm}
