...
%Moreover, Possibility Theory has its
...
\textit{i.e.} the preference function returns values 
from the qualitative scale $\mathcal{L}$,
...
optimistic, counterpart of the best case criterion
of one \cite{DBLP:journals/ijar/SabbadinFL98}.
