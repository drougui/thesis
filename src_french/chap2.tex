...
sous la forme d'arbre de décision algébriques (\textit{ADDs}) \cite{Bahar1997ADD}, 
...
\end{axis}
\end{tikzpicture}
\caption[Résultats d'IPPC 2014: problèmes \textit{Elevators} et \textit{Skill teaching}]{
Résultats de la compétition internationale de planification probabiliste -- session entièrement observable}
