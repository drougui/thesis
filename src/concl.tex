...
If a given state $s$ is perfectly known 
...
an elementary event can be defined as ``possible'',
...
on the other motivations developped in Introduction:
...
(\textit{i.e.} belief states on the human assessment).
