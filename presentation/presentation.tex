...
$\rightarrow$ image in the database representative enough of the reality?\\% (test/train)% $\Rightarrow$ hard extraction of a classifier \\
...
using poss-prob tranformations {\footnotesize \textit{(Dubois $\&$ Prade)}}% $\textbf{p} \paren{ o' \sachant s,a } = \sum_{s' \in \mathcal{S}} O(s',a,o') \cdot T(s,a,s');$
