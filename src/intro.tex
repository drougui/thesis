...
than sum and product
which produce ADDs with potentially
more leaves.
...
of this chapter exhibit sufficient conditions 
...
at the International Probabilistic Planning Competition\footnote{\url{https://cs.uwaterloo.ca/~mgrzes/IPPC_2014/}}.
We participated in the competition 
in order to test the performances of our algorithm
against probabilistic one, in terms of expected reward,
with various probabilistic planning problems. 
