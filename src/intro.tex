...
as well-fulfilled as possible 
especially for 
the first executions of the process:
RL algorithms are not useful in this context
the dataset of recorded mission executions 
