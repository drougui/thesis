...
Suppose now that we wanted to compute 
such a frequentist probability distribution 
describing a given frequentist situation.
Consider that some of 
the elementary events 
$\omega \in \Omega$
stored in this dataset
have been imprecisely observed: 
instead of the actual elementary event,
a disjunctive set of events is returned
describing the actual imprecision of the observation,
as the actual elementary event is not clear in practice.
