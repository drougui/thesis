...
presented above: possibility and necessity measure. 
...
poss qual < poss quant / proba TODO
PSR \cite{Littman01predictiverepresentations} 
as representation approximated in a more compact way

%%% IMPRECISION MODELISATION
Moreover, Qualitative Possibility Theory
...
%TODO with a model built from imprecise data
...
what the Qualitative Possibility Theory 
can bring in Planning under Uncertainty
in partially observable domains, 
and more generaly in 
Sequential uncertainty management, 
...
studied in order to answer to the presented concerns.
