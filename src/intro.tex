...
because of prohibitive computation time and/or RAM needed.
Second we presented 
...
has been discussed:
defining the initial agent's lack of knowledge 
...
\textit{i.e.} computations are performed 
...
However, this interesting question 
...
the parameter imprecision issue,
as well as the agent knowledge issue, 
...
\textit{i.e.} this probability is the number 
of times this event occurred 
in a sufficiently big dataset of events, 
over the size of the used dataset. %%% TODO
