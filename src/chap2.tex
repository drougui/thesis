...
some possibility distributions can be defined from the fact that each node is M-independent from its non-descendants
...
comes from the fact that PPUDD's ADDs should be smaller because their leaf
